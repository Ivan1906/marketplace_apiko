...
import AddProductView from './AddModalProductView';
...
const enhancer = compose(withRouter, connect(mapStateToProps, mapDispatchToProps), withState('initialValue', 'ChangeInitialValue', {
  title: '',
  location: '',
  description: '',
  photos: [],
